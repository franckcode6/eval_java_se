...
public class Piece implements Mouvement {
	...
	public static List<Piece> toDelete = new ArrayList<Piece>();
	...
	public static void setToDelete(List<Piece> toDelete) {
		Piece.toDelete = toDelete;
	}

	public static void setPosPrisesBlanc(List<Position> posPrisesBlanc) {
		Piece.posPrisesBlanc = posPrisesBlanc;
	}

	public static void setPosPrisesNoir(List<Position> posPrisesNoir) {
		Piece.posPrisesNoir = posPrisesNoir;
	}

	public static void setTabPiece(List<Piece> tabPiece) {
		Piece.tabPiece = tabPiece;
	}

	public void setMouvementExecutable(List<Position> mouvementExecutable) {
		this.mouvementExecutable = mouvementExecutable;
	}
